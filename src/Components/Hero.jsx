    ...
    return (
        <div className='w-full h-screen flex justify-center mt-5'>
            ...
            <div className='absolute z-10 left-[40px] md:left-[50px] md:top-[122px] sm:top-[110px] top-[105px] bg-white/75 sm:bg-white dark:bg-[#030637]/75 sm:dark:bg-[#030637] lg:w-[500px] lg:h-[450px] md:w-[410px] md:h-[450px] sm:w-[390px] sm:h-[470px] w-[260px] h-[380px]'>
                ...
                <h1 className='text-4xl sm:text-6xl mt-2 ml-[10px] lg:ml-[44px] font-semibold dark:text-white'>Best Shipping <br/><span className='font-bold text-[#FFC117]'>Partner</span></h1>
                <p className='mt-4 lg:mt-8 ml-[10px] lg:ml-[45px] text-black/90 dark:text-white'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem perspiciatis veniam labore nostrum sed omnis nulla neque magni, in consectetur?</p>
            ...
            <div className='z-10 absolute bottom-0 left-0 w-[120px] h-[40px] p-3 mt-6 text-xs text-white font-semibold bg-[#FFC117]'>
