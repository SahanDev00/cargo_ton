            ...
            <div className='md:grid md:grid-cols-2 block w-[90%] h-[500px] md:mx-[5%] lg:gap-0 md:gap-4 lg:mx-auto mt-16'>
                <div className=''>
                    ...
                    <div className='relative'>
                        ...
                        <p className='max-w-[300px] text-[14px] sm:max-w-[400px] ml-24 sm:ml-32 top-4 sm:top-9 sm:text-[20px] md:max-w-[300px] absolute  md:text-[13px] md:top-6 md:ml-12 lg:top-10 xl:top-16 lg:ml-16 xl:ml-24 xl:text-[16px] lg:text-[14px] text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident veritatis voluptates, vel possimus incidunt sed laboriosam sit minima maxime rem quo dignissimos quae ullam obcaecati fugit distinctio aspernatur.</p>
                    </div>
                    <div className='flex items-center dark:text-white'>
                        <div className='flex ml-7 md:ml-5'>
                            <LuArrowLeftSquare className='size-6 cursor-pointer'/>
                            <LuArrowRightSquare className='size-6 cursor-pointer'/>
                        </div>
                        <div className='sm:ml-80 md:ml-36 lg:ml-56 xl:ml-72 ml-52'>
